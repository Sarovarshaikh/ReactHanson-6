...

      {
        ...
        <div>
          <div className='edit-div'>
            ...
            <input name='Course' required onChange={changeHandler} value={store.Course} placeholder='Batch' type="text" />
            
            <input name='Batch' required onChange={changeHandler} value={store.Batch} placeholder='Course' type="text" />
          </div>
